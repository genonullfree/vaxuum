...
mod test {
    ...
    #[test]
    /* Test based upon geno signal message */
    fn test_devax() {
        let unvaxxinated = vec!(0x0f, 0x00, 0x24, 0x21, 0x09, 0x53, 0x45, 0x54,
                                0x20, 0x4e, 0x4f, 0x56, 0x45, 0x52, 0x49, 0x46, 0x59);
        let vax = devax(unvaxxinated).unwrap();
        let expected_vax = vec!(0x24, 0x21, 0x09, 0x53, 0x45, 0x54,
                            0x20, 0x4e, 0x4f, 0x56, 0x45, 0x52, 0x49, 0x46, 0x59, b'\n');
        assert_eq!(expected_vax, vax);
    }
}
